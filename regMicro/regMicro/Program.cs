...
class Program
{
    static void Main()
    {
        ...
        try
        {
            ...
            driver.Navigate().GoToUrl("https://signup.live.com/signup?mkt=VI-VN&lic=1&uaid=5229336bef804703ac000200c2b965c9");
            wait = new WebDriverWait(driver, TimeSpan.FromSeconds(10));

            Thread.Sleep(1000);

            // Nhập email
            IWebElement emailInput = driver.FindElement(By.XPath("//*[@id=\"usernameInput\"]"));
            emailInput.SendKeys(mail);

            // Click vào nút "Đăng ký"
            IWebElement signUpButton = driver.FindElement(By.XPath("//*[@id=\"nextButton\"]"));
            signUpButton.Click();
